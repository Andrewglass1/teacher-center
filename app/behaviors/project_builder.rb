module ProjectBuilder
  class << self
    ...
    def create_by_project_url(project_url)
      Project.find_or_create_by_dc_id(build_project(project)) if find_by_url(project_url)
    end

    def find_by_url(project_url)
      DonorsChooseApi::Project.find_by_url(project_url)
    end
